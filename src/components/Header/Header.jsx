          ...
          <div className="flex w-full mx-auto text-left bg-{#fffaf2} ">
            ...
            <div className="relative inline-flex items-center mx-auto align-middle">
              <div className="pb-12 text-center">
                <h1 className="max-w-5xl text-2xl font-bold leading-none tracking-tighter text-neutral-600 md:text-5xl lg:text-[3.4rem] lg:max-w-7xl">
                  Your success story begins with a resume.
                  <br className="hidden" /> Craft your perfect resume in minutes
                </h1>
              </div>
            </div>
          </div>
        ...
        <div className=" px-5 py-12 mx-auto lg:px-16">
          <div className="flex flex-col w-full mb-8 text-center">
            <span className="mb-4 text-sm font-medium tracking-wide text-gray-500 uppercase">
              Search resumes of our customers who got hired. They’re our heroes.
              They can help.{" "}
              <a
        ...
        <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
          <div className="flex flex-wrap items-center mx-auto max-w-7xl">
            ...
            <div className="flex flex-col items-start mt-12 mb-16 text-left lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0">
              ...
              <h1 className="mb-8 text-4xl font-bold leading-none tracking-tighter text-neutral-600 md:text-7xl lg:text-[2.8rem]">
                Land Your Dream Job with a Standout Resume: Build Yours Today.
              </h1>
              ...
              <div className="flex-col mt-0 lg:mt-6 max-w-7xl sm:flex">
                <div className="prose prose-md">
                  <ul>
                    <li className="text-gray-500">Resume Builder</li>
                    <li className="text-gray-500">Cover Letter Builder</li>
                    <li className="text-gray-500">Resume Checker</li>
                  </ul>
                </div>
              </div>
            </div>
