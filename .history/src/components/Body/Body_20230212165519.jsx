  ...
  return (
    <div className="p-8 flex flex-col items-center pt-0">
      ...
      <div className="w-full flex justify-between items-center">
        ...
        <button className="rounded bg-blue-500 text-white font-medium text-base flex items-center cursor-pointer py-[8px] px-[16px] border-0 leading-tight gap-5 outline-none">
