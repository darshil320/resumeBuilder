      ...
      <section className="w-full bg-white dark:bg-wickeddark">
        <div className="relative items-center w-full px-5 py-12 mx-auto md:px-12 lg:px-16 max-w-7xl lg:py-24">
          <div className="flex w-full mx-auto text-left">
            <img
              class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded bg-{#fffaf2}"
              alt="hero"
              src="https://d1civoyjepycei.cloudfront.net/static/img/cta/cta.0cc6580caa52.jpg"
            ></img>
