...
<section className="bg-neutral-50">
    <div className=" px-5 py-12 mx-auto lg:px-16">
        ...
        <a href="https://www.wickedtemplates.com/expo.html" className="font-semibold text-blue-600 lg:mb-0 hover:text-blue-500">Our customers »</a>
            </span>
        </div>
